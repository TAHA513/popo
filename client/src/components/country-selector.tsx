...
const popularCountries: Country[] = [
  { name: "Iraq - العراق", code: "IQ", flag: "🇮🇶" },
  { name: "Saudi Arabia - السعودية", code: "SA", flag: "🇸🇦" },
  { name: "United Arab Emirates - الإمارات", code: "AE", flag: "🇦🇪" },
  { name: "Egypt - مصر", code: "EG", flag: "🇪🇬" },
  { name: "Jordan - الأردن", code: "JO", flag: "🇯🇴" },
  { name: "Kuwait - الكويت", code: "KW", flag: "🇰🇼" },
  { name: "Lebanon - لبنان", code: "LB", flag: "🇱🇧" },
  { name: "Qatar - قطر", code: "QA", flag: "🇶🇦" },
  { name: "Bahrain - البحرين", code: "BH", flag: "🇧🇭" },
  { name: "Oman - عُمان", code: "OM", flag: "🇴🇲" },
