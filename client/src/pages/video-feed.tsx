        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute right-4 bottom-20 flex flex-col items-center space-y-4 pointer-events-auto">
            ...
            <div className="relative">
              ...
              <Button
                size="sm"
                className="absolute -bottom-1 left-1/2 transform -translate-x-1/2 bg-red-500 hover:bg-red-600 text-white w-5 h-5 rounded-full p-0 font-bold text-sm border border-white"
              >
                +
              </Button>
            </div>
